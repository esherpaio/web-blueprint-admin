...
class OrderView(ModelView):
    ...
    actions = [
        ...
        ApiAction(
            ...
            style="warning",
            text="A shipment will be added and the customer will be notified.",
            irreversible=True,
        ...
        ApiAction(
            ...
            endpoint=lambda o: f"/api/v1/orders/{o.id}",
            style="warning",
            text="The order will be cancelled and a refund might be created.",
            irreversible=True,
        ...
        ApiAction(
            ...
            style="warning",
            text="A refund will be created. The default value is the maximum refundable amount.",
            irreversible=True,
